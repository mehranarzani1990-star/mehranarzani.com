...
export const metadata: Metadata = {
  ...
  description: "Mehran Arzani is a battery and chemical engineering researcher focused on electrode fabrication, electrolyte engineering, electrochemical interfaces, battery diagnostics, and next-generation energy storage.",
